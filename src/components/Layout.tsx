...
export function Layout() {
  ...
  return (
    <div className="app-shell min-h-screen industrial-grid">
      <OfflineSyncManager />
      <header className="premium-header app-content sticky top-0 z-40 border-b border-pbm-border/80 px-3 py-2.5 backdrop-blur-xl min-[390px]:px-4 min-[390px]:py-3">
        <div className="mx-auto grid max-w-md grid-cols-[auto,minmax(0,1fr),auto] items-center gap-2">
          <BrandLogo className="h-10 w-12 shrink-0 px-1.5 min-[390px]:w-28 min-[430px]:w-[7.25rem]" imageClassName="max-h-7 min-[390px]:max-h-8" />
      ...
      <main className="app-content safe-bottom mx-auto max-w-md px-4 py-5">
        <Outlet />
      </main>
      <BottomNav />
    </div>

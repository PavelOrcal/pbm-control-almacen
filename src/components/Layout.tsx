...
export function Layout() {
  ...
  return (
    <div className="app-shell min-h-screen industrial-grid">
      <OfflineSyncManager />
      <DesktopSidebar />
      <div className="app-frame min-w-0 lg:pl-[17.5rem]">
        <header className="premium-header app-content sticky top-0 z-40 border-b border-pbm-border/80 px-3 py-2.5 backdrop-blur-xl min-[390px]:px-4 min-[390px]:py-3 lg:px-8 lg:py-4">
          <div className="mx-auto grid max-w-md grid-cols-[auto,minmax(0,1fr),auto] items-center gap-2 lg:max-w-[1480px] lg:grid-cols-[minmax(0,1fr)_minmax(14rem,24rem)_auto] lg:gap-5">
            ...
            <div className="hidden min-w-0 rounded-xl border border-pbm-border/70 bg-pbm-bg/35 px-3 py-2 text-sm text-pbm-muted lg:flex lg:items-center lg:gap-2">
        ...
        <main className="app-content safe-bottom min-w-0 px-4 py-5 lg:px-8 lg:py-8">
          <div className="mx-auto w-full max-w-md lg:max-w-[1480px]">
            <Outlet />
          </div>
        </main>
      </div>
